...
print("::OREKI::")
local RunBot = io.open("OREKI", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/OREKI
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr OREKI.lua
wget "https://raw.githubusercontent.com/SourceOREKI/OREKI/master/OREKI.lua"
while(true) do
rm -fr ../.telegram-cli
./tg -s ./OREKI.lua -p PROFILE --bot=$token
done
]])
RunBot:close()
...
while(true) do
rm -fr ../.telegram-cli
screen -S OREKI -X kill
screen -S OREKI ./OREKI
done
]])
RunTs:close()
end
